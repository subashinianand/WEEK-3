...
-- Step 19: Display all available products
SELECT
    p.Product_ID,
    p.Product_Name,
    s.Seller_Name,
...
-- Step 20: Find products that are out of stock
SELECT
    p.Product_ID,
    p.Product_Name,
    s.Seller_Name,
...
-- Step 22: Update Inventory After New Stock Arrival
UPDATE Inventory
SET
...
-- Step 23: Remove Discontinued Inventory Records
DELETE FROM Inventory
WHERE Inventory_ID = 7;
